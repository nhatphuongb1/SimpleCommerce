...
namespace SimplCommerce.WebHost.Migrations
{
    ...
    [Migration("20190304094637_update-ProductDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Areas.Catalog.ViewModels.ProductThumbnail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long?>("CalculatedProductPriceId");
                    ...
                    b.HasIndex("CalculatedProductPriceId");

                    b.HasIndex("ProductId");

                    b.HasIndex("ThumbnailImageId");

                    b.ToTable("Catalog_ProductThumbnail");
                });
            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Models.CalculatedProductPrice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("PercentOfSaving");

                    b.Property<decimal>("Price");

                    b.HasKey("Id");

                    b.ToTable("Catalog_CalculatedProductPrice");
                });
            ...
            modelBuilder.Entity("SimplCommerce.Module.Catalog.Areas.Catalog.ViewModels.ProductThumbnail", b =>
                {
                    b.HasOne("SimplCommerce.Module.Catalog.Models.CalculatedProductPrice", "CalculatedProductPrice")
                        .WithMany()
                        .HasForeignKey("CalculatedProductPriceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SimplCommerce.Module.Catalog.Models.Product")
                        .WithMany("SameBrandProducts")
